...
var Content = function (_React$Component) {
  ...
  createClass(Content, [{
    ...
    value: function render() {
      ...
      var spellCheck = slateDevEnvironment.IS_FIREFOX ? false : props.spellCheck;
...
function cloneFragment(event, value) {
  ...
  if ((slateDevEnvironment.IS_CHROME || slateDevEnvironment.IS_SAFARI) && !endVoid && startKey === endKey) {
  ...
  if (slateDevEnvironment.IS_CHROME || slateDevEnvironment.IS_SAFARI) {
